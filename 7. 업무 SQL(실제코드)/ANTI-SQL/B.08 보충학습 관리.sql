...
from tblscore s 
 ...
 select*from  vwAddStudy where "교사번호"= fnteacherSeq('rhnjkwgajkl');                                    
 select*from  vwAddStudy where "교사번호"= fnteacherSeq('rhnjkwgajkl') and "실기점수"<30;    --실기점수가 30점에 못미치는 학생조회 
